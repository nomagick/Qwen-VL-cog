...
def chat_stream_raw(
    ...
    **kwargs,
    ...
    token_blacklist = {tokenizer.eod_id, tokenizer.im_start_id, tokenizer.im_end_id}
    ...
    for token in self.generate_stream(
        ...
        **kwargs,
        ...
        filtered = [x for x in outputs if x not in token_blacklist]
        last_response = tokenizer.decode(filtered, skip_special_tokens=False, errors="ignore")
